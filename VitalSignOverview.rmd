...
for(i in 1:nrow(protocols)){
  ...
  cat("Below are the deliverables expected after each remeasurement of this Vital Sign according to the following protocol:\n\n",Citation,"  \n")
...
--,[RecordInsertedBy]
 ...
 WHERE ProtocolID=",ProtocolID," ORDER BY DeliverableIdentifier",sep="")
  ...
  cat("### Remeasurements  \n")
  cat("Below are the remeasurements conducted according to the following protocol:\n\n",Citation,"  \n")
